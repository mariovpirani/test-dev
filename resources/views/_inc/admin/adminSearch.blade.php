...
<div class="table-responsive">
	<table class="table">
		...
		<tbody>
			@foreach($ticketSearch as $ReturnAnswer)
			<tr>
				...
				<td><a href="view/{{$ReturnAnswer->ticketToken}}" class="btn btn-dark"><i class="fa fa-edit"></i></a></td>
			</tr>
		</tbody>
		@endforeach
...
<div class="row">
	<div class="col-sm-12 ">
		<span class="float-right">{{ $ticketSearch->links() }}</span>
	</div>
</div>
</section>